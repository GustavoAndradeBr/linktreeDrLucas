...
Site de linktree para médico, construído com React, Framer Motion e Tailwind CSS.
...
export const doctor = {
  ...
  photo: '/foto-dr.jpg',       // Foto (opcional, coloque na pasta /ASSET)
  available: true,             // Ponto verde de "disponível, eu tirei pq acho feio"
}
...
1. Coloque a foto do Dr. na pasta `/assets/` com o nome `foto-dr.jpg`
...
```
dr-linktree/
├── assets/              # Arquivos estáticos (foto, favicon)
├── src/
│   ├── components/
